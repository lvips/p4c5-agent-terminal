...
static const pmic_reg_entry_t s_init_seq[] = {
    ...
    { 0x14, 0x00, false, "MIN_SYS_VOL_CTRL",
      "最低系统电压 (VSYS) = 3.0V (默认 0x00 = 3.0V+0×0.1V)", NULL },
    { 0x15, 0x00, false, "INPUT_VOLT_LIMIT_CTRL",
      "输入欠压保护 = 3.88V (bit[6:4]=0b000 = 3.88V)", NULL },
    { 0x16, 0x05, false, "INPUT_CURR_LIMIT_CTRL",
      "输入限流 = 500mA (bit[2:0]=0b101; axp2101.c 用查表: index 5 = 500mA)",
      "R2.3: 实测值与注释不一致(注释写350mA), xiaozhi 配置用查表方式" },
